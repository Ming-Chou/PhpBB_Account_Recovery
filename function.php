...
function connect_phpBB(){
	$servername = "127.0.0.1";	//資料庫位址 Database IP
	$username = "";				//資料庫帳號 Database Username
	$password = "";				//資料庫密碼 Database Password
	$dbname = "csie";			//資料庫名稱 Database Name
...
function recaptcha_vertify($response){
    ...
    $url = sprintf($url, "", $response, $_SERVER['REMOTE_ADDR']); //自行替換 serectkey
...
function recaptcha_display(){
	...
	return '<script src="https://www.google.com/recaptcha/api.js" async defer></script>
		<div class="g-recaptcha" data-sitekey=""></div>'; //自行替換 sitekey
...
////////////////////////////////////////////////////////////	
	$gmail_Account="";  			//Gmail 帳號/Account
	$gmail_Password="";        		//Gmail 密碼/Password
////////////////////////////////////////////////////////////
